#!/bin/bash -l
#$ -N CelebA_redone_CEM_lam1_0
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_redone_CEM_lam1_0_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_redone_CEM_lam1_0_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=34:30:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
LOCAL_CONFIG="experiments/configs/celeba_redone_cem_lam1_0.yaml"
