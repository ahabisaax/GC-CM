#!/bin/bash -l
#$ -N CBM_Leakage_CelebA_CRCEM
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_CRCEM_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_CRCEM_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=10:00:00
#$ -l mem=24G
#$ -l tmpfs=20G
...
echo "Starting Training (CRCEM only)..."
