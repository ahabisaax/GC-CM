#!/bin/bash -l
#$ -N CBM_Leakage_CelebA_CBM
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_CBM_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_CBM_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=30:00:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
FINAL_RESULTS_DIR=$PROJECT_ROOT/results/celeba_cbm_39c
...
LOCAL_CONFIG="experiments/configs/celeba_cbm_39c.yaml"
