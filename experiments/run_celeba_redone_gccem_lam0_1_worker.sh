#!/bin/bash -l
#$ -N CelebA_redone_GCCEM_lam0_1
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_redone_GCCEM_lam0_1_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_redone_GCCEM_lam0_1_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=20:00:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
LOCAL_CONFIG="experiments/configs/celeba_redone_gccem_lam0_1.yaml"
