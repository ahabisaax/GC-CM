#!/bin/bash -l
#$ -N CelebA_8c_CEM
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_8c_CEM_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_8c_CEM_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=6:00:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
LOCAL_CONFIG="experiments/configs/celeba_8c_cem.yaml"
