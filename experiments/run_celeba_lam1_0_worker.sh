#!/bin/bash -l
#$ -N CBM_Leakage_CelebA_lam1_0
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_lam1_0_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_lam1_0_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=10:00:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
FINAL_RESULTS_DIR=$PROJECT_ROOT/results/celeba_cem_lam1_0
