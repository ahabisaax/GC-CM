#!/bin/bash -l
#$ -N CBM_Leakage_CelebA_ACBM_lam0_5
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_ACBM_lam0_5_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_ACBM_lam0_5_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=20:00:00
#$ -l mem=4G
#$ -l tmpfs=20G
...
FINAL_RESULTS_DIR=$PROJECT_ROOT/results/celeba_acbm_39c_lam0_5
