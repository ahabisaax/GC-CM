#!/bin/bash -l
#$ -N CelebA_CRCEM_lam0_1
#$ -o ~/Scratch/xai-crcbm/logs/CelebA_CRCEM_lam0_1_$JOB_ID.out
#$ -e ~/Scratch/xai-crcbm/logs/CelebA_CRCEM_lam0_1_$JOB_ID.err
#$ -pe smp 8
#$ -l h_rt=30:30:00
#$ -l mem=24G
#$ -l tmpfs=20G
